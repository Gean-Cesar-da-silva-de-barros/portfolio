...
function imgbtn() {
    ...
    mudarimg.src = mudarimg.src.includes("moon50black.png") ? imgMoonWhite : imgMoonBlack; //troca a img do botao
}
function trocarImagemLinkedin() {
    let linkedinBlack = "./imagens/linkedinblack50.png";
    let linkedinWhite = "./imagens/linkedinwhite50.png";
    imgLinkedin.src = imgLinkedin.src.includes("linkedinblack50.png") ? linkedinWhite : linkedinBlack
}
function trocarImagemInstagram() {
    ...
    imgInstagram.src = imgInstagram.src.includes("instagramblack50.png") ? instagramWhite : instagramBlack; //troca a img do instagram
}
function trocarImagemGmail() {
    const gmailBlack = "./imagens/gmailblack50.png";
    const gmailWhite = "./imagens/gmailwhite50.png";
    imgGmail.src = imgGmail.src.includes("gmailblack50.png") ? gmailWhite : gmailBlack; //troca a img do gmail
}
